...
class Application(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.label3 = Label(root, text = COLNAMES[2], padx = 0, pady = 0)
        ...
        self.label4 = Label(root, text = COLNAMES[3], padx = 0, pady = 0)
        ...
        self.label5 = Label(root, text= COLNAMES[4], padx = 0, pady = 0)
        ...
        self.label6 = Label(root, text = COLNAMES[5], padx = 0, pady =0)
        ...
        self.label7 = Label(root, text = COLNAMES[6], padx = 0, pady = 0)
